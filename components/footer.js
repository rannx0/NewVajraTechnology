            ...
            <div>
              ...
              <Link href="/" className="flex items-center space-x-2 text-2xl font-medium text-indigo-500 dark:text-gray-100">
                    <Image
                      ...
                      className="w-8"
                    />
                  <span>Vajra Technology</span>
              </Link>
            </div>

            <div className="max-w-md mt-4 text-gray-500 dark:text-gray-400">
            VAJRA Technology adalah perusahaan IT profesional yang siap membantu Anda mengoptimalkan teknologi untuk meningkatkan efisiensi bisnis dan mencapai kesuksesan.
            </div>
          </div>
